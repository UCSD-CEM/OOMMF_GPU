...
#puts "DepPath = $deppath"
	...
	set deppath $tmppath
	set cudaInc "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v5.0/include"
	set micInc "C:/Program Files (x86)/Intel/Composer XE 2013/mkl/include"
	#set deppath [concat $deppath [list $cudaInc]]
	#set deppath [concat $deppath [list $micInc]]
