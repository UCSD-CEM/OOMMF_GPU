 ...
 )
{
  ...
  ++calc_count;
  #ifdef GPU_DEBUG
location = fopen ("location.txt","a");
fprintf(location,"something before GetEnergy(state,oed) in void Oxs_Energy::GetEnergyData...\n");
fclose(location);
#endif
  GetEnergy(state,oed);
 ...
 Oxs_ComputeEnergyData& oced) const
{
  ...
  #ifdef GPU_DEBUG
location = fopen ("location.txt","a");
fprintf(location,"before GetEnergy(state,oed) in void Oxs_Energy::ComputeEnergy...\n");
fclose(location);
#endif
  GetEnergy(state,oed);
